...
You have to follow the Logs Data Platform naming convention `<service_name>-i-<suffix>` to create your index. Your username is the one you use to connect to Graylog or to use the API. The suffix can contain any alphanumeric characters.
